...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: ${LightColors.text}; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background-color: ${LightColors.background}; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
    ...
    <div style="text-align: center; margin: 30px 0;">
      <div style="background-color: ${LightColors.primary}; color: ${DarkColors.text}; width: 50px; height: 50px; line-height: 50px; border-radius: 50%; display: inline-block; font-size: 30px;">
        ✓
      </div>
    </div>
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: ${LightColors.text}; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background-color: ${LightColors.background}; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
    ...
    <div style="text-align: center; margin: 30px 0;">
      <a href="{resetURL}" style="background-color: ${LightColors.primary}; color: ${DarkColors.text}; padding: 12px 20px; text-decoration: none; border-radius: 5px; font-weight: bold;">Reset Password</a>
    </div>
